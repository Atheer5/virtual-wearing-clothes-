                ...
                if(task.isSuccessful()){
                    ...
                    try {
                        databaseReference = FirebaseDatabase.getInstance().getReference()
                                .child("virtualwearingclothes").child("Customers");
                        ...
                        Customer customer = new Customer(CustomerId, fullname, phonenumber, password,address);
                        databaseReference.push().setValue(customer);


                        Intent intent = new Intent(sendCodeVrification.this,login.class);
