                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                                            if (dataSnapshot2.exists()) {//at second time
...
//___________________________________________________________________________________________________________________________________________
                                                    ...
                                                    if (FilePathUri != null) {
                                                        ...
                                                        storageReference2.putFile(FilePathUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                            ...
                                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                ...
                                                                storageReference2.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                    ...
                                                                    /*
                                                                        Intent intent = new Intent(AddNewDescription.this,EStoreOwnerDashboard.class);//////////...............................................
                                                        ...
                                                        Toast.makeText(AddNewDescription.this, "Please Select Image", Toast.LENGTH_LONG).show();
